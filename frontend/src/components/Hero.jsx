...
function Hero() {
  return (
    <div>
      <div className='hero-section ml-32 mt-16 h-[320px] relative flex items-center' style={{ zIndex: 10 }}>
        <img className='hero-image opacity-70' src={herojpg} alt="hero-section" />
